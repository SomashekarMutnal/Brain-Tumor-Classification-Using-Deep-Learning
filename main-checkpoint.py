...
#bg_image = Image.open("Basaveshwar Engineering College (BEC), Bagalkot Featured Pic.png")
...
message3 = tk.Label(window, text="Intelligent attendence management system" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
clearButton = tk.Button(frame2, text="Clear", command=clear, fg="white", bg="#007BFF", width=11, activebackground="#0056b3", font=('comic', 11, 'bold'))
clearButton.place(x=335, y=86)

clearButton2 = tk.Button(frame2, text="Clear", command=clear2, fg="white", bg="#007BFF", width=11, activebackground="#0056b3", font=('comic', 11, 'bold'))
clearButton2.place(x=335, y=172)

takeImg = tk.Button(frame2, text="Take Images", command=TakeImages, fg="white", bg="#28A745", width=34, height=1, activebackground="#218838", font=('comic', 15, 'bold'))
takeImg.place(x=30, y=300)

trainImg = tk.Button(frame2, text="Save Profile", command=psw, fg="white", bg="#28A745", width=34, height=1, activebackground="#218838", font=('comic', 15, 'bold'))
trainImg.place(x=30, y=380)

trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages, fg="white", bg="#17A2B8", width=13, height=1, activebackground="#138496", font=('comic', 12, 'bold'))
trackImg.place(x=160, y=85)

quitWindow = tk.Button(frame1, text="Quit", command=window.destroy, fg="white", bg="#DC3545", width=35, height=1, activebackground="#c82333", font=('comic', 15, 'bold'))
quitWindow.place(x=30, y=460)
...
def send_email():
    ...
    from_email = "somashekarmutnal02@gmail.com"  # Update with your email
    password = "xvrq sejl ngmq irfg"  # Update with your email password
